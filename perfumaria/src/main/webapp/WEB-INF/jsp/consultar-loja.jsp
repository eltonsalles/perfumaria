    ...
    <form action="sistema?controller=Loja&action=pesquisar" method="post">
        <div class="form-group col-md-6 <c:if test="${errorValidation.pesquisar eq true}">has-error</c:if>">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="pesquisar" placeholder="Digite o nome ou CNPJ" name="pesquisar" maxlength="150" pattern="^([a-zA-Zà-úÀ-Ú0-9]{1,})|([a-zA-Zà-úÀ-Ú0-9]|\.|-|\s)+$">
