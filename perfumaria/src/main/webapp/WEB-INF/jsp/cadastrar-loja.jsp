...
<div class="col-md-10 content">
    ...
    <form action="sistema?controller=Loja&action=<c:out value="${sessionScope.loja.id > 0 ? 'editar' : 'novo'}"></c:out>" method="post">
            ...
            <div class="form-group col-md-5 <c:if test="${errorValidation.razaoSocial eq true}">has-error</c:if>">
                <label class="control-label" for="razao-social">Razão Social</label>
                <input type="text" class="form-control" id="nome" placeholder="Razão social" name="razao-social" maxlength="150" required pattern="^([a-zA-Zà-úÀ-Ú0-9])([a-zA-Zà-úÀ-Ú0-9]|\.|\s)+$" value="<c:out value="${sessionScope.loja.razaoSocial}"></c:out>">
            </div>
            ...
            <div class="form-group col-md-5 <c:if test="${errorValidation.nomeFantasia eq true}">has-error</c:if>">
                ...
                <input type="text" class="form-control" id="nome-fantasia" placeholder="Nome Fantasia" name="nome-fantasia" maxlength="150" required pattern="^([a-zA-Zà-úÀ-Ú0-9])([a-zA-Zà-úÀ-Ú0-9]|\.|\s)+$" value="<c:out value="${sessionScope.loja.razaoSocial}"></c:out>">
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-5 <c:if test="${errorValidation.logradouro eq true}">has-error</c:if>">
                    ...
                    <input type="text" class="form-control" id="logradouro" placeholder="Rua, Avenida..." name="logradouro" maxlength="150" required  pattern="^([a-zA-Zà-úÀ-Ú0-9])([a-zA-Zà-úÀ-Ú0-9]|\.|-|\s)+$" value="<c:out value="${sessionScope.loja.logradouro}"></c:out>">
                </div>
                ...
                <div class="form-group col-md-4 <c:if test="${errorValidation.bairro eq true}">has-error</c:if>">
                    ...
                    <input type="text" class="form-control" id="bairro" name="bairro" maxlength="50" required pattern="^([a-zA-Zà-úÀ-Ú0-9])([a-zA-Zà-úÀ-Ú0-9]|\.|-|\s)+$" value="<c:out value="${sessionScope.loja.bairro}"></c:out>">
                </div>
                <div class="form-group col-md-4 <c:if test="${errorValidation.cidade eq true}">has-error</c:if>">
                    <label class="control-label" for="cidade">Cidade</label>
                    <input type="text" class="form-control" id="cidade" name="cidade" maxlength="50" required pattern="^([a-zA-Zà-úÀ-Ú])([a-zA-Zà-úÀ-Ú]|\.|-|\s)+$" value="<c:out value="${sessionScope.loja.cidade}"></c:out>">
                </div>
